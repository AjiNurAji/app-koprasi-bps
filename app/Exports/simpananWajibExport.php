...
class simpananWajibExport implements FromView, ShouldAutoSize
{
    ...
    public function view(): View
    {
        ...
        foreach ($members as $key => $value) {
            $members[$key]->simpanan_wajib = SimpananWajib::whereBetween('tanggal_transaksi', [$this->start_date, $this->end_date])->where('id_member', $value->id_member)->get();
        ...
        $totals = SimpananWajib::whereBetween('tanggal_transaksi', [$this->start_date, $this->end_date])->get();
