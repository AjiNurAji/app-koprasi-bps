    ...
    return (
        <>
            ...
            {/* <div className="flex justify-center items-center min-h-screen bg-bodydark1 dark:bg-black">
                <div className="rounded-md border w-full sm:w-fit border-stroke bg-white shadow-default p-5 dark:border-strokedark dark:bg-boxdark">
            ...
            <div className="flex items-center justify-between min-h-screen w-full">
                <BoxIlus />
                <div className="basis-1/2 h-screen flex justify-center items-center bg-white dark:bg-boxdark-2">
                    <div className="flex justify-center items-center flex-col gap-3 w-9/12">
                        <div className="flex justify-center items-center flex-col gap-2">
                            <div className="w-20 h-auto overflow-hidden">
                                <img className="w-full" src={Logo} alt="Logo" />
                            </div>
